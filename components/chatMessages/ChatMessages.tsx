  ...
  return (
    <div className="p-5">
      {!loading && messages?.length === 0 ? (
        <div className="flex flex-col justify-center items-center text-center p-20 rounded-xl space-y-2 main-gradient-bg text-white font-extralight text-lg">
        ...
        <div className="flex flex-col justify-center items-center text-center mb-10 p-8 rounded-xl space-y-2 main-gradient-bg text-white font-extralight text-lg">
          <p>The AI will auto-detect & translate it all for you.</p>
        </div>
      )}
          ...
          <div key={message.id} className="flex my-2 items-end">
            <div
              className={`flex flex-col relative space-y-2 p-4 w-fit line-clamp-1 mx-2 rounded-lg ${
                isSender
                  ? "ml-auto bg-[#3f5efb] text-white rounded-br-none"
            ...
            >
              ...
              <div className="flex space-x-2">
                ...
                {!message.translated && <SpokeSpinner />}
              </div>
            </div>
