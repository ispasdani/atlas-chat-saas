...
type ChatMembersBadgeProps = {
  chatId: string;
};

function ChatMembersBadge({ chatId }: ChatMembersBadgeProps) {
  ...
  if (loading && !members) return <SpokeSpinner />;

  return (
    !loading && (
      <div className="p-2 border rounded-xl m-5 bg-white">
